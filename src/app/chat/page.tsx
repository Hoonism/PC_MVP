...
function ChatPageContentRefactored() {
  ...
  return (
    <div className="h-full flex flex-row overflow-hidden bg-gray-50 dark:bg-[#212121]" role="main">
      ...
      <div className="flex-1 flex flex-col h-full min-h-0 overflow-hidden">
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 p-4 bg-white dark:bg-[#212121]">
          <div className="max-w-3xl mx-auto">
            ...
            <div id="input-description" className="text-xs text-gray-500 dark:text-gray-500 text-center mt-2">

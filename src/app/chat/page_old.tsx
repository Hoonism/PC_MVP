...
function ChatPageContent() {
  ...
  // Auto-save effect - saves chat after messages change (with debounce)
  useEffect(() => {
    // Don't auto-save if:
    // - User not logged in
    // - Only initial message
    // - Currently loading
    if (!user || messages.length <= 1 || isLoading) {
      return
    }
  ...
  const autoSaveChat = async () => {
    ...
    try {
      ...
      // Trigger refresh of saved chats list
      ...
      >
        <div className="flex flex-col h-full min-h-0 overflow-hidden bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded">
          ...
          <div className="p-3 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
            {selectedFile && (
              <div className="mb-2 flex items-center gap-2 px-3 py-2 bg-blue-50 dark:bg-blue-900/20 rounded">
            ...
            <div className="flex gap-2">
              ...
              <label
                ...
                className="px-3 py-2 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 rounded cursor-pointer flex items-center justify-center transition-colors"
                title="Upload bill"
              >
